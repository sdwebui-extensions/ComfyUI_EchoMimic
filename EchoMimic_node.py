...
cache_path = os.path.join(folder_paths.cache_dir, "models/echo_mimic")
...
if not os.path.exists(weigths_deepface_current_path):
    os.makedirs(weigths_deepface_current_path, exist_ok=True)
